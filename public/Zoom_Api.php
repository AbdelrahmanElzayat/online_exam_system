...
class Zoom_Api
{
	private $zoom_api_key = '98T7K_xSR_2K9KqS1lBazA';
	private $zoom_api_secret = '5EwM3TfkKWYe0vIICkZLSv7thW3iahUpf5Vj';	
	...
	//function to send request
    	...
    	{
		//Enter_Your_Email
		$request_url = "https://api.zoom.us/v2/users/elzaem.ammar12@gmail.com/meetings";
